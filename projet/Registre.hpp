...
public:
    ...
    void modifStatutContact(Personne laPersonne);     // Modifier le statut du booléen contacté.
    void modifStatutRdv(Personne laPersonne);         // Modifier le statut du booléen rdv.
    void modifStatutVaccination(Personne laPersonne); // Modifier le statut de la vaccination.
